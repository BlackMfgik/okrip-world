  ...
  return (
    <div className="admin-shell">
      <header className="admin-header">
        <div>
          <p className="application-eyebrow">OKRIP WORLD · CONTROL ROOM</p>
          <h1>Адмін-панель</h1>
          <p>
            Заявки гравців і рішення щодо доступу до Minecraft-сервера.
          </p>
        </div>
      ...
      <div className="admin-applications">
        {data?.applications.map((application) => (
          <article className="admin-application-card" key={application.publicId}>
            <header>
              <div>
