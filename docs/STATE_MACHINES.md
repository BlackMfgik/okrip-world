...
`pending → approved | rejected | cancelled`. Схвалення виконується кнопкою Telegram одразу; відмова переходить у rejected лише після ForceReply-відповіді дозволеного адміністратора з валідною причиною. Рішення остаточне; повторний approve/reject повертає вже відомий стан. Після rejected/cancelled дозволена нова заявка з тим самим ніком, якщо player_access відсутній. Після будь-якого рішення про доступ нові заявки блокуються.
