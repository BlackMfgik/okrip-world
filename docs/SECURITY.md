...
Бани нестандартних Minecraft-плагінів без запису в ProfileBanList не можна виявити універсально. Потрібен адаптер до їх API або /okripban. Зберігайте delivery-journal.json між рестартами, обмежте доступ до config.yml. Після повної втрати whitelist-файлу вже completed команди автоматично не відтворюються: відновіть whitelist із backup або проведіть контрольовану повторну синхронізацію з аудитом.
